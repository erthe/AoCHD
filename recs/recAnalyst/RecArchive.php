 ...
 *
 * @package recAnalyst
 * @version $Id: RecArchive.php 52 2012-06-01 10:05:24Z biegleux $
...
class RecArchive {
	...
	protected function getDetails() {
		...
		for ($i = 0; false !== ($stat = $this->_zip->statIndex($i)); $i++) {
			...
			if ($ext != self::MGX_EXT && $ext != self::MGL_EXT && $ext != self::MSX_EXT && $ext != self::AOE_EXT) {
				continue;
			}
