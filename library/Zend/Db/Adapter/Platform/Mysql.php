...
class Mysql implements PlatformInterface {
	...
	public function setDriver($driver) {
		...
		if ($driver instanceof Mysqli\Mysqli || ($driver instanceof Pdo\Pdo && $driver->getDatabasePlatformName () == 'Mysql')) {
			/**
		...
		// handle
		if ($driver instanceof \mysqli || ($driver instanceof \PDO && $driver->getAttribute ( \PDO::ATTR_DRIVER_NAME ) == 'mysql')) {
