        ...
        <fieldset>
            <table>
                ...
                <tr>
                    ...
                    <td colspan="6"><input type="text" readonly size="40" value="{$item.item_id}"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="power" size="5" value="{$item.power}"> </td>
                    <td><label>命中: </label></td>
                    <td><input type="text" name="hit_chance" size="5" value="{$item.hit_chance}"> </td>
                    <td><label>必殺: </label></td>
                    <td><input type="text" name="special_chance" size="5" value="{$item.special_chance}"> </td>
                    <td><label>重さ: </label></td>
                    <td><input type="text" name="weight" size="5" value="{$item.weight}"> </td>
                    <td><label>耐久: </label></td>
                    <td><input type="text" name="durability" size="5" value="{$item.durability}"> </td>
                </tr>
                
                <tr>
                    <td><label>武器レベル: </label></td>
                    <td><input type="text" name="weapon_level" size="5" value="{$item.weapon_level}"> </td>
                    ...
                    <td><input type="text" name="price" size="10" value="{$item.price}"> </td>
                </tr>
                
                 <tr>
                    <td><label>攻撃速度: </label></td>
                    <td><input type="text" name="attack_speed" size="5" value="{$item.attack_speed}"> </td>
                    <td><label>HP上昇: </label></td>
                    <td><input type="text" name="hp_plus" size="5" value="{$item.hp_plus}"> </td>
                    <td><label>STR上昇: </label></td>
                    <td><input type="text" name="str_plus" size="5" value="{$item.str_plus}"> </td>
                    <td><label>MAG上昇: </label></td>
                    <td><input type="text" name="mag_plus" size="5" value="{$item.mag_plus}"> </td>
                    <td><label>SKL上昇: </label></td>
                    <td><input type="text" name="skl_plus" size="5" value="{$item.skl_plus}"> </td>
                </tr>
                
                <tr>
                    <td><label>SPD上昇: </label></td>
                    <td><input type="text" name="spd_plus" size="5" value="{$item.spd_plus}"> </td>
                    <td><label>LUK上昇: </label></td>
                    <td><input type="text" name="luk_plus" size="5" value="{$item.luk_plus}"> </td>
                    <td><label>DEF上昇: </label></td>
                    <td><input type="text" name="def_plus" size="5" value="{$item.def_plus}"> </td>
                    <td><label>MDF上昇: </label></td>
                    <td><input type="text" name="mdf_plus" size="5" value="{$item.mdf_plus}"> </td>
                    <td><label>BOD上昇: </label></td>
                    <td><input type="text" name="bod_plus" size="5" value="{$item.bod_plus}"> </td>
