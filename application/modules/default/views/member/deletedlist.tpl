	            ...
	            <tbody>
	                ...
	                {foreach item=item from=$items}
	                    <tr id="trno_{$no}" class="list">
	                        ...
	                        {*<td class="editable text-center"><a href="playeredit/id/{$item.player_id|escape}?width=500&height=280&modal=true" class="thickbox"><img src="../themes/images/edit.png" alt="edit"></a></td>*}
	                        ...
	                        <td id="{$item.player_id|escape}" class="editable text-center"><span class="revert"><img src="../themes/images/revert.png" alt="revert"></span></td>
