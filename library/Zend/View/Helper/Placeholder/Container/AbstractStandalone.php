 ...
 */
abstract class AbstractStandalone extends \Zend\View\Helper\AbstractHelper implements \IteratorAggregate, \Countable, \ArrayAccess {
	/**
	 *
	...
	protected function escape($string) {
		if ($this->view instanceof RendererInterface && method_exists ( $this->view, 'getEncoding' )) {
