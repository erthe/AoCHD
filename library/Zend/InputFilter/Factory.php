...
class Factory {
	...
	public function createInputFilter($inputFilterSpecification) {
		...
		if (! $inputFilter instanceof InputFilterInterface) {
			throw new Exception\RuntimeException ( sprintf ( 'InputFilter factory expects the "type" to be a class implementing %s; received "%s"', 'Zend\InputFilter\InputFilterInterface', $class ) );
		}
