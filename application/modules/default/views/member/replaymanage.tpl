        ...
        <tbody>
            ...
            {foreach item=player from=$games}
                <tr id="trno_{$no}" class="list">
                    ...
                    <td class="text-center"><a href="../data/replay/{$player.replay_id}.html" target="_blank"><img src="../themes/images/show.png" alt="show"></a></td>
					<td class="text-center"><span id="{$player.gamelog_id|escape}" abbr="{$player.replay_id|escape}" class="delete"><img src="../themes/images/delete.png" alt="delete"></span></td>
                </tr>
                {$no = $no + 1}{$n = $n + 1}
            {/foreach}
        </tbody>
