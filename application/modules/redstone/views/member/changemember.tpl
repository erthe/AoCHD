<div class="modal-content">
	...
	<div class="modal-body">
	    <form id="member-edit" class="form-horizontal" method="post">
			<fieldset>
				...
				<div class="form-group">
					<div class="col-xs-12">
						{if isset($member.image)}
							...
							<button type="button" id="delete-img" class="btn btn-danger">画像の削除</button>
						{else}
							<button type="button" id="insert-img" class="btn btn-default">画像アップロード</button>
						{/if}
					</div>
				</div>

				<div class="form-group">
					<div class="col-sm-2"><input type="button" id="change-password" class="btn btn-info" value="パスワード変更"></div>
					<div class="pull-right col-sm-2"><input type="reset" id="reset" class="btn btn-warning" value="リセット"></div>
				</div>
				<input type="hidden" name="token" value="{$token}">
				<input type="hidden" name="action_tag" value="edit_member">
	        </fieldset>
	    </form>
    </div>
    
    <div class="modal-footer">
		<button id="member_edit" type="button" class="btn btn-primary">送信</button>
