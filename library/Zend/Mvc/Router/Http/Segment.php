...
class Segment implements RouteInterface {
	...
	protected function buildRegex(array $parts, array $constraints, &$groupIndex = 1) {
		...
		foreach ( $parts as $part ) {
			switch ($part [0]) {
                ...
                case// @codeCoverageIgnoreStart
				null 'translated-literal' :
	...
	public function assemble(array $params = array(), array $options = array()) {
		...
		return $this->buildPath ( $this->parts, array_merge ( $this->defaults, $params ), false, (isset ( $options ['has_child'] ) ? $options ['has_child'] : false) );
	}
