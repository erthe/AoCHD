...
class Uri implements UriInterface {
	...
	public function setScheme($scheme) {
		if (($scheme !== null) && (! self::validateScheme ( $scheme ))) {
			throw new Exception\InvalidUriPartException ( sprintf ( 'Scheme "%s" is not valid or is not accepted by %s', $scheme, get_called_class () ), Exception\InvalidUriPartException::INVALID_SCHEME );
		}
	...
	public function setHost($host) {
		if (($host !== '') && ($host !== null) && ! self::validateHost ( $host, $this->validHostTypes )) {
			throw new Exception\InvalidUriPartException ( sprintf ( 'Host "%s" is not valid or is not accepted by %s', $host, get_called_class () ), Exception\InvalidUriPartException::INVALID_HOSTNAME );
		}
