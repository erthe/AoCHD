<form id="matching_result" name="player_form" method="post" action="matching">
    <fieldset>
        <table>
            ...
            <tr>
                ...
                <td><input type="text" name="player_name9" autocomplete="off" value="{$team1_list[0][1]}" id="text_9" size="17" style="display: block;" />
                <div id="suggest_9" class="suggestion" name="suggest9" style="display:none;"></div></td>
                <td><label>rate: </label></td>
                <td><input class="text-right" type="text" readonly name="rate9" value="{$team1_list[0][2]}" size="5">
                <input type="hidden" name="player_id9" value="{$team1_list[0][0]}"></td>
            	<td><label>name： </label></td>
                <td><input type="text" name="player_name10" id="text_10" value="{$team2_list[0][1]}" autocomplete="off" size="17" style="display: block" />
                <div id="suggest_10" class="suggestion" name="suggest10" style="display:none;"></div></td>
                <td><label>rate: </label></td>
                <td><input class="text-right" type="text" readonly name="rate10"  size="5" value="{$team2_list[0][2]}">
                <input type="hidden" name="player_id10" value="{$team2_list[0][0]}"></td>
            </tr>
                
            <tr>
                <td><label>name： </label></td>
                <td><input type="text" name="player_name11" autocomplete="off" value="{if $team1_number>=2}{$team1_list[1][1]}{/if}" id="text_11" size="17" style="display: block;" />
                <div id="suggest_11" class="suggestion" name="suggest11" style="display:none;"></div></td>
                <td><label>rate: </label></td>
                <td><input class="text-right" type="text" readonly name="rate11" size="5" value="{if $team1_number>=2}{$team1_list[1][2]}{/if}">
                <input type="hidden" name="player_id11" value="{if $team1_number>=2}{$team1_list[1][0]}{/if}"></td>
            	<td><label>name： </label></td>
                <td><input type="text" name="player_name12" id="text_12" value="{if $team2_number>=2}{$team2_list[1][1]}{/if}" autocomplete="off" size="17" style="display: block" />
                <div id="suggest_12" class="suggestion" name="suggest12" style="display:none;"></div></td>
            	<td><label>rate: </label></td>
                <td><input class="text-right" type="text" readonly name="rate12" size="5" value="{if $team2_number>=2}{$team2_list[1][2]}{/if}">
                <input type="hidden" name="player_id12" value="{if $team2_number>=2}{$team2_list[1][0]}{/if}"></td>
            </tr>
                
            <tr>
                <td><label>name： </label></td>
                <td><input type="text" name="player_name13" autocomplete="off" value="{if $team1_number>=3}{$team1_list[2][1]}{/if}" id="text_13" size="17" style="display: block;" />
                <div id="suggest_13" class="suggestion" name="suggest13" style="display:none;"></div></td>
                <td><label>rate: </label></td>
                <td><input class="text-right" type="text" readonly name="rate13" size="5" value="{if $team1_number>=3}{$team1_list[2][2]}{/if}">
                <input type="hidden" name="player_id13" value="{if $team1_number>=3}{$team1_list[2][0]}{/if}"></td>
             	<td><label>name： </label></td>
                <td><input  type="text" name="player_name14" id="text_14" value="{if $team2_number>=3}{$team2_list[2][1]}{/if}" autocomplete="off" size="17" style="display: block" />
                <div id="suggest_14" class="suggestion" name="suggest14" style="display:none;"></div></td>
                <td><label>rate: </label></td>
                <td><input class="text-right" type="text" readonly name="rate14" size="5" value="{if $team2_number>=3}{$team2_list[2][2]}{/if}">
                <input type="hidden" name="player_id14" value="{if $team2_number>=3}{$team2_list[2][0]}{/if}"></td>
            </tr>
                
            <tr>
                <td><label>name： </label></td>
                <td><input type="text" name="player_name15" autocomplete="off" value="{if $team1_number>=4}{$team1_list[3][1]}{/if}" id="text_15" size="17" style="display: block;" />
                <div id="suggest_15" class="suggestion" name="suggest15" style="display:none;"></div></td>
                <td><label>rate: </label></td>
                <td><input class="text-right" type="text" readonly name="rate15" size="5" value="{if $team1_number>=4}{$team1_list[3][2]}{/if}">
                <input type="hidden" name="player_id15" value="{if $team1_number>=4}{$team1_list[3][0]}{/if}"></td>
             	<td><label>name： </label></td>
                <td><input type="text" name="player_name16" id="text_16" value="{if $team2_number>=4}{$team2_list[3][1]}{/if}" autocomplete="off" size="17" style="display: block" />
                <div id="suggest_16" class="suggestion" name="suggest16" style="display:none;"></div></td>
                <td><label>rate: </label></td>
                <td><input class="text-right" type="text" readonly name="rate16" size="5" value="{if $team2_number>=4}{$team2_list[3][2]}{/if}">
            ...
            <tr>
                <td colspan="8">
                    <input id="game_start" type="submit" value="ゲーム開始">
                </td>
            </tr>
