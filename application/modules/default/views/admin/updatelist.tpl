            ...
            <tbody>
                ...
                {foreach item=item from=$items}
                    <tr id="trno_{$no}" class="list">
                        ...
                        <td class="editable text-center"><a href="#" id="update_edit" name="{$item.updatelog_id|escape}"><img src="../themes/images/edit.png" alt="edit"></a></td>
                        <td id="{$item.update_id|escape}" class="editable text-center"><span class="delete"><img src="../themes/images/delete.png" alt="delete"></span></td>
                    </tr>
                    {$no = $no + 1}
                {/foreach}
            </tbody>
