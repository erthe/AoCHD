...
class AdminController extends Zend_Controller_Action {
	...
	public function init() {
		...
		$this->view->changecomment = htmlspecialchars($root_dir . 'views/member/changeusercomment.tpl', ENT_QUOTES);
			...
			try {
				...
				switch($game_status) {
					...
					case 0:
						...
						foreach($player as $array) {
							$fixedresult = RateSet($array, $fixedgame, $num);
							var_dump($fixedgame);
							$result3 = $result3 + $this->model->update('rate', $fixedresult);
						}
						break;
