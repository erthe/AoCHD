        ...
        <table id="tbl" class="table-center">
            <thead>
                <tr>
                    ...
                    <th id="sort_status2" abbr="win" name="{$sortkey2}" class="number text-center">勝利<img id="status2" class="icon" src="{$order2}"></th>
                    <th id="sort_status3" abbr="lose" name="{$sortkey3}" class="number text-center">敗北<img id="status3" class="icon" src="{$order3}"></th>
