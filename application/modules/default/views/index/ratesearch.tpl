<div class="form-container">
    ...
    <form id="search" method="post" class="form-inline text-center">
        ...
        <div class="form-group text-center"><input type="text" name="search_rate_up" size="7"  class="form-control input-sm text-right" placeholder="最高レート" value="{$search_rate_up}" /></div>
        <div class="form-group text-center"><input type="text" name="search_rate_down" size="7"  class="form-control input-sm text-right" placeholder="最低レート" value="{$search_rate_down}" /></div>
