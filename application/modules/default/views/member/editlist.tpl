<div id="list">
	            ...
	            <tbody>
	                ...
	                {foreach item=item from=$items}
	                    <tr id="trno_{$no}" class="list">
	                        ...
	                        <td id="{$item.player_id}" class="editable text-center"><span class="delete"><img src="../themes/images/delete.gif" alt="delete"></span></td>
	...
	<div class="option">
	    ...
	    <a href="playercreate?width=500&height=255&modal=true" class="thickbox">プレイヤー新規登録</a>
	    <a href="playerdeleted">削除済みプレイヤー</a>
	    <a href="gamemanage">ゲームの修正</a>
	    <a href="editpassword?width=250&height=100&modal=true" class="thickbox">パスワード変更</a>
