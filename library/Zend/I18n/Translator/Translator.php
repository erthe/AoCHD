...
class Translator {
	...
	protected function loadMessages($textDomain, $locale) {
		...
		$messagesLoaded = ($this->loadMessagesFromRemote ( $textDomain, $locale ) || $this->loadMessagesFromPatterns ( $textDomain, $locale ) || $this->loadMessagesFromFiles ( $textDomain, $locale ));
